    ...
    void TakeLife()
    {
        ...
        if (playerLives == 0)
        {
            ...
            if (showGUI)
            {
                ...
                GameObject.Find("Score").GetComponent<GUIText>().text = "Your Score is: " + playerPoints;
                GameObject.Find("Score").GetComponent<GUIText>().enabled = true;
                GameObject.Find("ResetGO").GetComponent<GUIText>().enabled = true;
                GameObject.Find("backMMGO").GetComponent<GUIText>().enabled = true;
                GameObject.Find("GameOverBG2").GetComponent<GUITexture>().enabled = true;
            }
